...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '51c11a8d-c3d3-4782-aa33-01a2b3ce6abb' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('345687d1-b25b-4b08-84fb-9cefac1e4c24');
      cy.get(`[data-cy="name"]`).should('have.value', '345687d1-b25b-4b08-84fb-9cefac1e4c24');
